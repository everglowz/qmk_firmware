...
// ----- Copied from https://github.com/moben/qmk_firmware/blob/master/users/manna-harbour_miryoku/manna-harbour_miryoku.h
...
// NAV + NUM - clipboard + keypad symbols (+-/*)
#define MIRYOKU_TABLE_VIEWER_FULL \
      KC_LBRC,          KC_7,             KC_8,             KC_9,             KC_RBRC,          KC_PPLS,          KC_LSFT,          KC_LCTL,          KC_LALT,          KC_LGUI, \
      KC_SCLN,          KC_4,             KC_5,             KC_6,             KC_EQL,           KC_PMNS,          KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT, \
      KC_GRV,           KC_1,             KC_2,             KC_3,             KC_BSLS,          KC_PSLS,          KC_HOME,          KC_PGDN,          KC_PGUP,          KC_END, \
      U_NP,             U_NP,             KC_DOT,           KC_0,             KC_MINS,          KC_ENT,           KC_BSPC,          KC_PAST,           U_NP,             U_NP
